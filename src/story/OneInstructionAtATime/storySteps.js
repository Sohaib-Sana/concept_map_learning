    ...
    beats: [
      {
        ...
        revealTriggers: [{ phrase: "what to do", reveal: { nodes: ["n2"], edges: ["n1-n2"] }, focus: ["n1", "n2"] }],
        focus: "n1",
        images: [],
      },
    ],
    ...
    beats: [
      {
        ...
        revealTriggers: [{ phrase: "instructions in software", reveal: { nodes: ["n3"], edges: ["n3-n2"] }, focus: "n3" }],
        focus: ["n1", "n2"],
        images: [],
      },
      {
        ...
        revealTriggers: [{ phrase: "an instruction", reveal: { nodes: ["n4"], edges: ["n2-n4", "n4-n3"] }, focus: "n4" }],
        focus: "n2",
        images: [],
      },
      {
        ...
        revealTriggers: [{ phrase: "it to do", reveal: { nodes: ["n5"], edges: ["n4-n5", "n5-n3"] }, focus: "n5" }],
        focus: "n2",
        images: [],
      },
    ],
    ...
    beats: [
      {
        ...
        revealTriggers: [{ phrase: "out the command", reveal: { nodes: ["n6"], edges: ["n5-n6", "n6-n3"] }, focus: "n6" }],
        focus: "",
        images: [],
      },
    ],
    ...
    beats: [
      {
        ...
        revealTriggers: [{ phrase: "carries it out", reveal: { nodes: [], edges: ["n6-n4"] }, focus: ["n4", "n6"] }],
